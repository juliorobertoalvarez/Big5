...
<html lang="es">
    <head>
        ...
        <title>Big5 - JulioRobalva</title>
        <!-- Favicon-->
        <link rel="icon" type="image/x-icon" href="assets/img/gt.ico" />
    ...
    <body id="page-top">
            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-10 align-self-end">
                        <h1 class="text-uppercase text-white font-weight-bold">Big 5</h1>
        ...
        <section class="page-section" id="services">
            <div class="container">
                <h2 class="text-center mt-0">Big 5</h2>
                <hr class="divider my-4" />
                <div class="row">
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="mt-5">
                            <i class="fas fa-4x fa-gem text-primary mb-4"></i>
                            <h3 class="h4 mb-2">Facil</h3>
                            <p class="text-muted mb-0">Puedes entender y realizarlo con facilidad.</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="mt-5">
                            <i class="fas fa-4x fa-laptop-code text-primary mb-4"></i>
                            <h3 class="h4 mb-2">Rapido</h3>
                            <p class="text-muted mb-0">No tendras que esperar nada para tener la informacion.</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="mt-5">
                            <i class="fas fa-4x fa-globe text-primary mb-4"></i>
                            <h3 class="h4 mb-2">Comodo</h3>
                            <p class="text-muted mb-0">Puedes hacerlo desde cualquier parte del mundo</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="mt-5">
                            ...
                            <p class="text-muted mb-0">Realizado por JulioRobAlva para el mundo.</p>
                        </div>
                    </div>
                </div>
            </div>
